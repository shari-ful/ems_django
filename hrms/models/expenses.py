...
class ExpenseReceipt(models.Model):
    expense_id = models.IntegerField(null=True)
    trip_id = models.IntegerField(null=True)
    receipt_name = models.CharField(max_length=100, null=True)
    receipt_filename = models.CharField(max_length=100, null=True)
...
class Expense(models.Model):
    ...
    expense_currency = models.CharField(max_length=300, null=True)
    ...
    application_currency = models.CharField(max_length=300, null=True)
